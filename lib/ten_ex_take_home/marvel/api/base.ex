defmodule TenExTakeHome.Marvel.API.Base do
  ...
  defmacro __using__(opts) do
    quote do
      ...
      @spec list(map) :: map
      def list(params \\ %{}) do
        API.Base.get(unquote(opts[:entity]), params)
      end
      ...
      def get(id, params \\ %{}) do
        API.Base.get("#{unquote(opts[:entity])}/#{id}", params)
      end
      ...
      if unquote(opts[:entity]) != "characters" && unquote(opts[:entity]) != "creators" do
        ...
        def characters(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/characters", params)
        end
      end
      ...
      if unquote(opts[:entity]) != "comics" do
        ...
        def comics(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/comics", params)
        end
      end
      ...
      if unquote(opts[:entity]) != "creators" && unquote(opts[:entity]) != "characters" do
        ...
        def creators(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/creators", params)
        end
      end
      ...
      if unquote(opts[:entity]) != "events" do
        ...
        def events(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/events", params)
        end
      end
      ...
      if unquote(opts[:entity]) != "series" && unquote(opts[:entity]) != "comics" do
        ...
        def series(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/series", params)
        end
      end
      ...
      if unquote(opts[:entity]) != "stories" do
        ...
        def stories(id, params \\ %{}) do
          API.Base.get("#{unquote(opts[:entity])}/#{id}/stories", params)
        end
      end
    end
  end
